...
w_lenght_m = float(input())
h_withd_m = float(input())
w_lenght_cm = w_lenght_m * 100
h_withd_cm = h_withd_m * 100
h_withd_cm = h_withd_cm - 100
number_desk = h_withd_cm // 70
number_seats = w_lenght_cm // 120
total_places = int(number_desk * number_seats - 3)
print(total_places)
