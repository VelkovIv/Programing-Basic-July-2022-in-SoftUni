...
if budget <= 1000 :
    ...
    if season == "Summer":
        location = "Alaska"
        price_of_vacation = budget * 0.65
    else:
        location = "Morocco"
        price_of_vacation = budget * 0.45

elif budget > 3000 :
    place = "Hotel"
    price_of_vacation = budget * 0.9
    if season == "Summer":
        location = "Alaska"
    else:
        location = "Morocco"
    ...
    if season == "Summer":
        location = "Alaska"
        price_of_vacation = budget * 0.80
    else:
        location = "Morocco"
        price_of_vacation = budget * 0.60
print(f"{location} - {place} - {price_of_vacation:.2f}")