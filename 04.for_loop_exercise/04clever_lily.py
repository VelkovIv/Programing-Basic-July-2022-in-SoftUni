...
# С парите искала да си купи пералня за X лева. Напишете програма, която да пресмята, колко пари е събрала и дали ѝ стигат
# да си купи пералня.
# Вход
...
for i in range(1,lily_age+1):
    if i % 2 == 0:
        birth_day_money += i * 5 - 1
    else:
        toy_numbers += 1
toys_total_money = toy_price * toy_numbers
total_money = birth_day_money + toys_total_money
